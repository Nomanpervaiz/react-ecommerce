...
function AppContact() {
  return (
    ...
    <section className=" body-font relative container">
      <div className="text-center mt-5 ">
        <h1 className="sm:text-5xl text-2xl font-medium title-font  mb-3">
          Contact Us
        </h1>
        <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nulla, rerum! Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit, corrupti!
        </p>
      ...
      <div className="container px-2 py-16 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-1/2 md:w-2/1 bg-gray-300 rounded-lg overflow-hidden sm:mr-0 p-10 flex items-end justify-start relative">
          <iframe
            width="100%"
            height="100%"
        ...
        <div className="lg:w-1/3 md:w-1/1  flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
